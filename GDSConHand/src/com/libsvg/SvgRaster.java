...
public class SvgRaster {
	...
	public static Bitmap createBitmap(int w, int h) {
		return Bitmap.createBitmap(w, h, Bitmap.Config.ARGB_4444);// Fix the out of memory issue
	}
	...
	public static Bitmap data2bitmap(int w, int h, int[] data) {
		return Bitmap.createBitmap(data, w, h, Bitmap.Config.ARGB_4444); // Fix the out of memory issue
	}
