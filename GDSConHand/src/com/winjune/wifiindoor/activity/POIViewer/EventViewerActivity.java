...
public class EventViewerActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.title_section_time);
			case 1:
				return getString(R.string.title_section_place);
			}
			return null;
		}
	}
