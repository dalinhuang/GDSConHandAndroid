...
public class CollectStatusReplyJsonParser extends AbstractJsonParser<CollectStatusReply> {
	 ...
	 */
	@Override
	protected CollectStatusReply parseInner(JsonPullParser parser) throws IOException,
			WebError, WebParseException {
		Gson gson = new Gson();
		CollectStatusReply info = gson.fromJson(parser.getContent(), CollectStatusReply.class);
		return info;
	}
}
