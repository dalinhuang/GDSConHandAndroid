...
public class NaviInfo implements Serializable{
	...
	private void setAlias(XStream xs){
		xs.alias("NaviInfo", com.winjune.wifiindoor.map.NaviInfo.class);
		xs.alias("NaviNode", com.winjune.wifiindoor.map.NaviNode.class);
		xs.alias("NaviData", com.winjune.wifiindoor.map.NaviData.class);
